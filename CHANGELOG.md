...
## [6.0.0](https://github.com/pryzmian/cadence-discord-bot/compare/v5.7.0...v6.0.0) (2024-04-21)
...
* Make pino-pretty and pino-loki optional dependencies, removed old pretty scripts and created new dev script ([056e052](https://github.com/pryzmian/cadence-discord-bot/commit/056e052ba4b50c1f20cbb2b7b803a80b9142129c))


### Features

* add /join command ([9901374](https://github.com/pryzmian/cadence-discord-bot/commit/990137468e7ce1302b22ac5f5b935a551812814d))
* add biquad filters support ([0b94a9b](https://github.com/pryzmian/cadence-discord-bot/commit/0b94a9b5ec3fdb3108cbd0bd960c9d97ea866c76))
* Add new /history command to show previously played tracks ([bf461c2](https://github.com/pryzmian/cadence-discord-bot/commit/bf461c2f26ebbc24f6e3dc1d33b0657bfec3f065))
* Add new /move command to move a track to specified position ([100325b](https://github.com/pryzmian/cadence-discord-bot/commit/100325b7d819243cc8785edbad69f8f02c9a55e9))
* Add new config option to enable/disable button labels ([47d3c36](https://github.com/pryzmian/cadence-discord-bot/commit/47d3c36cc727531eaa4436d069c28d1426f88602))
* Add norwegian localization file (no) ([a0dd74e](https://github.com/pryzmian/cadence-discord-bot/commit/a0dd74e8d86a54d0a515cdc56b2fe4d80c61f3c7))
* Added /back command to go back in history ([e11df37](https://github.com/pryzmian/cadence-discord-bot/commit/e11df3706fa02dfdba73c8b3856071b7cca1b785))
* added equalizer filters to /filters command ([9584fe8](https://github.com/pryzmian/cadence-discord-bot/commit/9584fe8ebe7b1cb97200d7a13e8763b1f4babba2))
* Implement Prisma for persistent storage ([ad29a63](https://github.com/pryzmian/cadence-discord-bot/commit/ad29a6388d491d0d1fcde0d976dfc6d94bada154))
* Localization support, breaking change. ([28592b1](https://github.com/pryzmian/cadence-discord-bot/commit/28592b13d836f52f501ab9d0b6168cdf7174804b))
* **music:** implement Song Announce Feature ([99c3cd0](https://github.com/pryzmian/cadence-discord-bot/commit/99c3cd006f075957a22eaa6f408706bab4592d66))
* Optionally add pino-pretty and pino-loki transports if installed ([eb9eceb](https://github.com/pryzmian/cadence-discord-bot/commit/eb9eceb5398564bfcf4c2b39db8edba1a5659b59))
* refactored handling of validators ([8c05499](https://github.com/pryzmian/cadence-discord-bot/commit/8c05499f08df6fac9cf7159a34b5a13cd642d7dc))
* **settings:** created settings command. ([1c98fd6](https://github.com/pryzmian/cadence-discord-bot/commit/1c98fd6c41326fe3467f5da204409e0c38793dce))
* show queue total duration in footer, update uptime duration format ([b139516](https://github.com/pryzmian/cadence-discord-bot/commit/b1395164ea0d4117ecf6ae5f09a4eeecb25c3d86))
* Updated /remove command with options for range, queue, user and duplicates! ([27d4c6c](https://github.com/pryzmian/cadence-discord-bot/commit/27d4c6c0220e84f4005c077a768040528ebbdffb))


### Minor changes and bug fixes

* add bun scripts to package.json ([00aaece](https://github.com/pryzmian/cadence-discord-bot/commit/00aaece22766a9a900c809a18c3ce288725dfad4))
* Add check on startup to see if ffmpeg is available ([0b72e92](https://github.com/pryzmian/cadence-discord-bot/commit/0b72e926934e5dc942a4af8b24458a2d299c7e03))
* add config option for open source url and icon ([4f29399](https://github.com/pryzmian/cadence-discord-bot/commit/4f29399a8eb2204b72e89e5bffdac730aca5fc13))
* add missing translator for /systemstatus title ([e216791](https://github.com/pryzmian/cadence-discord-bot/commit/e21679152bc060e45e2a7089624806b714aa95e4))
* Add new action buttons also to /history command ([fac39e4](https://github.com/pryzmian/cadence-discord-bot/commit/fac39e45cbd752db7148ea4be590a5cd05a88fb9))
* Add Open source button to /status ([fa84e29](https://github.com/pryzmian/cadence-discord-bot/commit/fa84e2925e048819e56b37f1257699653daf472b))
* add requested by string before mention ([e3efa48](https://github.com/pryzmian/cadence-discord-bot/commit/e3efa48ade580db411246b85afcd57bf7a516dff))
* Add track position to footer when track(s) added to queue in /play ([d496945](https://github.com/pryzmian/cadence-discord-bot/commit/d496945949e58d7430c61177a3d38f0e178195e2))
* add translation of unexpected error ([b953179](https://github.com/pryzmian/cadence-discord-bot/commit/b953179e965c64c1f3359d936b83a2d34d5baff3))
* add user in footer on validation warnings ([eb26f5a](https://github.com/pryzmian/cadence-discord-bot/commit/eb26f5ab93019b36a9a2dab85a819c7a28ae9c83))
* Added setup for unit tests ([f04d5ab](https://github.com/pryzmian/cadence-discord-bot/commit/f04d5ab79b360ba1f66cb2913ef1d24f08896ca2))
* also translate command params for /help ([e2040ba](https://github.com/pryzmian/cadence-discord-bot/commit/e2040baa8d0943d0295e62a9c29dceb67298cbdd))
* await client.login, thanks to @Kriblin ([64a709b](https://github.com/pryzmian/cadence-discord-bot/commit/64a709b03226b2f4d2b0489bdd7d3ba59f59e2fc))
* Better handling of unavailable source  after added to queue ([69d23d1](https://github.com/pryzmian/cadence-discord-bot/commit/69d23d1b77fc9066abd2cc532e5a54c36c0f064c))
* change addNumberOption to addIntegerOption ([6ca7ce3](https://github.com/pryzmian/cadence-discord-bot/commit/6ca7ce3e4be92e9240208c76c6bdf1418193ccef))
* change Dockerfile base image to fix mediaplex not working ([3360782](https://github.com/pryzmian/cadence-discord-bot/commit/3360782d2ed8bf5cd05933f25f2de1c2a9cfaac5))
* change map to switch statement ([7018b69](https://github.com/pryzmian/cadence-discord-bot/commit/7018b690bbc591b1b1eb689dfb4b36ab199165f3))
* changed loop mode option input to number ([c4bb6ee](https://github.com/pryzmian/cadence-discord-bot/commit/c4bb6eef3fed1a3e5e6c2869b35a688aeb271812))
* check for duplicate /track/id in spotify url and trim ([b3b73ad](https://github.com/pryzmian/cadence-discord-bot/commit/b3b73ad49f920dfd81598ea15c20b6ab87fa5ea4))
* dont log error object before handling ([c35a3ad](https://github.com/pryzmian/cadence-discord-bot/commit/c35a3ad5aac96309f9f2afacd22186d2613d1e1a))
* eslint formatting errors ([fec394f](https://github.com/pryzmian/cadence-discord-bot/commit/fec394ffc0886c44d557c61f1dc3dd0aa2e39d84))
* Extract logic for getting author value for embeds ([83e23d8](https://github.com/pryzmian/cadence-discord-bot/commit/83e23d87b4d79e8b37d45dcca15ecaa603e8a30d))
* extracted logic for retrieving shard status ([8da6f44](https://github.com/pryzmian/cadence-discord-bot/commit/8da6f44ebbf56ede204d515b03f6aca5339daeda))
* Fix .ENV file not being properly loaded ([1220ef1](https://github.com/pryzmian/cadence-discord-bot/commit/1220ef171f5b1266a481881d5f7b2c5daa185e5e))
* Fix deconstruction error if no lastQuery result in autocomplete ([851e932](https://github.com/pryzmian/cadence-discord-bot/commit/851e9321f561f1b50f52ad55c9497fea60be7300))
* fix duration validation not using padded and formatted duration ([c4f9403](https://github.com/pryzmian/cadence-discord-bot/commit/c4f9403ecffdefff892085bedd32c4d8da4c02d3))
* Fix not being able to select multiple ffmpeg filters ([83462ab](https://github.com/pryzmian/cadence-discord-bot/commit/83462ab6265937d0c517436cbf2a9bc60d1c1aaa))
* Fix playlist added position being incorrect in some cases ([664fa50](https://github.com/pryzmian/cadence-discord-bot/commit/664fa50dfe65d85a86808e6aa712d821025bc8c1))
* Fix posting bot stats status codes. ([6beb29d](https://github.com/pryzmian/cadence-discord-bot/commit/6beb29d8b75bcf3efd7e4237dc5b604e4d65eb00))
* Fix showing repeat mode in skipped track ([88511f8](https://github.com/pryzmian/cadence-discord-bot/commit/88511f87c1fffb7270a70fe4782789e1288c5f22))
* fix string comparison to lowercase for filter provider ([e89075e](https://github.com/pryzmian/cadence-discord-bot/commit/e89075ef440fb56c4a42ffee6f90cefa7d5b5a56))
* Fixed mapped guild list not being parsed by Bun ([d953fc9](https://github.com/pryzmian/cadence-discord-bot/commit/d953fc97af2d9c2ece7ed232a892609f7ba27559))
* increased default history size ([85e27af](https://github.com/pryzmian/cadence-discord-bot/commit/85e27afc5c53d70f78388337bdb60e965a8b633a))
* **lang:** Fixed translation string bug ([1728503](https://github.com/pryzmian/cadence-discord-bot/commit/1728503bb6c35ac0363214d3167216bfccc586d4))
* log error object in error handler ([79e1b5f](https://github.com/pryzmian/cadence-discord-bot/commit/79e1b5f3ada7820746f37787ef311c1e61b97127))
* New folder structure and organize files ([39ff5ec](https://github.com/pryzmian/cadence-discord-bot/commit/39ff5ecb5d2d28b06e161054f0c793531ce06506))
* override willAutoPlay event to set bot user as requestedBy ([aa36925](https://github.com/pryzmian/cadence-discord-bot/commit/aa3692592dc876c10b0372df399c1fb0925359ec))
* **playerSkip:** only log on error ([f5a39f4](https://github.com/pryzmian/cadence-discord-bot/commit/f5a39f430eb99c8702ad3cd502a385ef545bf22c))
* possibly solve duplicate event 'interactionCreate' listener bug ([2d08a9a](https://github.com/pryzmian/cadence-discord-bot/commit/2d08a9aa858fcd7f82c02fe0f0dc9b6e4524421c))
* refactor filters disable button ([9458ed6](https://github.com/pryzmian/cadence-discord-bot/commit/9458ed60a1c4eaf654bc32e9eb26bb719c0cf60b))
* refactor guilds command ([c689452](https://github.com/pryzmian/cadence-discord-bot/commit/c68945272e6b26654d1baa173d9087cba994b0ff))
* refactor loop command ([03c1d5d](https://github.com/pryzmian/cadence-discord-bot/commit/03c1d5d90f0c9860a21b3210281dac85498eba1b))
* refactor nowplaying command ([f061000](https://github.com/pryzmian/cadence-discord-bot/commit/f061000f933d89add34c8123ec1d8395e6da14fb))
* refactor postBotStats.ts ([f06f2ae](https://github.com/pryzmian/cadence-discord-bot/commit/f06f2ae352c72844317b519a46650807bddc3eb2))
* refactor remove command ([230ba5f](https://github.com/pryzmian/cadence-discord-bot/commit/230ba5fd9388ca67fa25720671706853e0a72aad))
* refactor volume command ([fca1a90](https://github.com/pryzmian/cadence-discord-bot/commit/fca1a9048986d56136994824b949545e68933abf))
* refactored autocomplete interactions ([af78759](https://github.com/pryzmian/cadence-discord-bot/commit/af7875981364fc01cc96d8d2c3624f3ac70dd2f9))
* refactored filters select menu component ([a9ce285](https://github.com/pryzmian/cadence-discord-bot/commit/a9ce2856502aeb6b27dfeefe3c5e43b5c2e0454b))
* refactored guilds command ([56b25f9](https://github.com/pryzmian/cadence-discord-bot/commit/56b25f9b97addc13ffb233ef45642dca6c990ae3))
* refactored help slash command ([9223377](https://github.com/pryzmian/cadence-discord-bot/commit/922337769da9260e0c9eb0004fce49c892d7951e))
* refactored lyrics command ([c1de63d](https://github.com/pryzmian/cadence-discord-bot/commit/c1de63da2735ada18dde25df9bfbe3c3a5212124))
* refactored nowplaying skip button component + more common methods ([78e8f12](https://github.com/pryzmian/cadence-discord-bot/commit/78e8f12c99f9f3650d013bb92c7a20177f59b636))
* refactored pause command, added common method getDisplayTrackDurationAndUrl() ([0850d9b](https://github.com/pryzmian/cadence-discord-bot/commit/0850d9b26d459dd8d9b6c81ec58cb47060b304f2))
* refactored play command and added common method for getting thumbnail url ([bf30d56](https://github.com/pryzmian/cadence-discord-bot/commit/bf30d565d7ad311a7daea5900fbe3d6bf1d7c008))
* refactored queue command, added more common methods ([1ebb7c3](https://github.com/pryzmian/cadence-discord-bot/commit/1ebb7c3b8951f2aca3f943e601b2fff127083fff))
* refactored seek command ([c871a75](https://github.com/pryzmian/cadence-discord-bot/commit/c871a758222cc99ce7e50eae916a9d79f4c5bd33))
* refactored shards command ([9259bc2](https://github.com/pryzmian/cadence-discord-bot/commit/9259bc2ffa8f9e4c72fd8baac5c203ec07f6f8b4))
* refactored skip command ([90346e7](https://github.com/pryzmian/cadence-discord-bot/commit/90346e74698864b999bfebd29df3d10fbfab646b))
* refactored status commands ([20bc4aa](https://github.com/pryzmian/cadence-discord-bot/commit/20bc4aa88f624719fe296092378e23fba94b1193))
* remove /guilds system command ([ccc4f19](https://github.com/pryzmian/cadence-discord-bot/commit/ccc4f19cc0911f663b503b1dbef48842b902db29))
* remove async from class methods for getting author ([fe14fc3](https://github.com/pryzmian/cadence-discord-bot/commit/fe14fc308fe1d85f04f528a649034043dfda21c8))
* remove async from getUptimeFormatted ([4041404](https://github.com/pryzmian/cadence-discord-bot/commit/4041404f01e58fd88009d73950691f2a5cbd3e1f))
* remove caching from npm ci in Dockerfile ([5e591c7](https://github.com/pryzmian/cadence-discord-bot/commit/5e591c739f7679efcf29df9e0ac37e12083bf0cd))
* remove incorrect ** from string ([cf45bde](https://github.com/pryzmian/cadence-discord-bot/commit/cf45bde80b42e69e7a8e797905502b261e86e269))
* remove unneccessary logging in leave command ([6999598](https://github.com/pryzmian/cadence-discord-bot/commit/6999598c8708e987233c4eaab1dcdf766ccd50be))
* remove unnecessary async/await ([7dc7b4f](https://github.com/pryzmian/cadence-discord-bot/commit/7dc7b4ff7e80df4c1979fb1e95ad511ce3bea831))
* remove unnecessary queue.clear() call in /stop ([f9fa501](https://github.com/pryzmian/cadence-discord-bot/commit/f9fa501125bc96ade97fc76dda65729712be5044))
* Replace support server and add bot info with link buttons in /help ([612e3a0](https://github.com/pryzmian/cadence-discord-bot/commit/612e3a00a65fc8c3aa36b5c0c0a012349d44ee09))
* set skipFFmpeg to false to solve bug ([ea8f97d](https://github.com/pryzmian/cadence-discord-bot/commit/ea8f97dc2b405b5ed0ace99b6016fd1937790117))
* small change to getEmbedQueueAuthor for bitrate calculation ([f3de02a](https://github.com/pryzmian/cadence-discord-bot/commit/f3de02a6a8f4fc8cfe3e80a8b49117d076b5a9f5))
* Small changes to new action buttons ([981be70](https://github.com/pryzmian/cadence-discord-bot/commit/981be707f04af0fd21481075683c63a3d0d42a2f))
* solve bug using getNumber after changing to addIntegerOption ([4b630e2](https://github.com/pryzmian/cadence-discord-bot/commit/4b630e2512282a481b50678714f7dd580d3f4be5))
* transform search query in /play autocomplete ([5601767](https://github.com/pryzmian/cadence-discord-bot/commit/56017678062a343f94f18ebb1ed770c6d9efe49a))
* update default config value for button labels to true ([ee54513](https://github.com/pryzmian/cadence-discord-bot/commit/ee5451320e99f92edeb89dbcf21641304f0ca296))
* update default leave settings ([ee0f769](https://github.com/pryzmian/cadence-discord-bot/commit/ee0f769ba5fe8ffe02aa66387e33dfdd5a484cc4))
* update deps ([dd06263](https://github.com/pryzmian/cadence-discord-bot/commit/dd06263699e6fc75d5c987ce1c59ce3f9bd03e0c))
* update deps ([e029314](https://github.com/pryzmian/cadence-discord-bot/commit/e029314ee2e125a90db2756b20e116a7b8fa45f5))
* update deps ([608dfe5](https://github.com/pryzmian/cadence-discord-bot/commit/608dfe556636bb4afae46093fd3f94f9af377c1f))
* update deps, change opus provider ([814029e](https://github.com/pryzmian/cadence-discord-bot/commit/814029e6361ed3824aa7854f7857b46ecb065c71))
* update extractor to stable ([d7ef706](https://github.com/pryzmian/cadence-discord-bot/commit/d7ef706604c3fb23b497075f3637b2c55c99cc92))
* update getDisplayRepeatMode showing wrong icon on success ([ea8cf10](https://github.com/pryzmian/cadence-discord-bot/commit/ea8cf100f5fb98b57fd19e1bd4ec40712968add5))
* update interactionCreate event handling ([7902a84](https://github.com/pryzmian/cadence-discord-bot/commit/7902a8427c5516c0586a86f27c2646cad1d81151))
* update mediaplex to latest ([78b5d85](https://github.com/pryzmian/cadence-discord-bot/commit/78b5d85c9e045eb26f47063f33d04dfef96e0f24))
* Update npm scripts ([9c4c995](https://github.com/pryzmian/cadence-discord-bot/commit/9c4c99558ae4b26febe84e7a56fc496591cb5c38))
* Update validators with new types ([e67d000](https://github.com/pryzmian/cadence-discord-bot/commit/e67d0004b05a7d6a72a723430c183880802cc6f4))
* Updated sending in checks for validation runner ([56056cd](https://github.com/pryzmian/cadence-discord-bot/commit/56056cd73d03d51d5a49e0cace710ccdcc930281))
* Updated some validator error messages ([04dd7a7](https://github.com/pryzmian/cadence-discord-bot/commit/04dd7a72181d69c6332692c4912c8fb5274a6581))
* use new runValidators format on components ([74c1447](https://github.com/pryzmian/cadence-discord-bot/commit/74c1447e7d27e7a87dcfc9d1893f232550365824))
* use Promise.all when fetching info for status commands ([2d7ffc1](https://github.com/pryzmian/cadence-discord-bot/commit/2d7ffc1a3ff9f58740dd1c77078feadcce6478d7))


### Miscellaneous

* add Bun CI workflow ([15b0a54](https://github.com/pryzmian/cadence-discord-bot/commit/15b0a54e298d237494ba2c1cdcc83880e03a1fbe))
* add jest coverage npm script ([b73dee5](https://github.com/pryzmian/cadence-discord-bot/commit/b73dee52adaf348cc0106527a7987b25908e0c47))
* adjust getUptimeFormatted method ([5558c0b](https://github.com/pryzmian/cadence-discord-bot/commit/5558c0bca2ec2241a2899e5e1c00a1a6090c0fce))
* created simple command class method unit test ([aa37704](https://github.com/pryzmian/cadence-discord-bot/commit/aa37704331e529248b612a803f94feb92505329f))
* **deps-dev:** bump @babel/traverse from 7.22.17 to 7.23.2 ([aea0683](https://github.com/pryzmian/cadence-discord-bot/commit/aea068377b3a6c338c1c620f00069a05a14c769f))
* **deps-dev:** bump @types/jest from 29.5.4 to 29.5.5 ([c689589](https://github.com/pryzmian/cadence-discord-bot/commit/c689589b495ebb56c20c58c0f1dd2de4e4671ae1))
* **deps-dev:** bump @types/jest from 29.5.5 to 29.5.6 ([a36cbee](https://github.com/pryzmian/cadence-discord-bot/commit/a36cbee8b90567670f348c772e5e5d99f1412270))
* **deps-dev:** bump @types/jest from 29.5.6 to 29.5.8 ([f98dbeb](https://github.com/pryzmian/cadence-discord-bot/commit/f98dbeb05c067b489a3d616860f5945c6261c5e4))
* **deps-dev:** bump @types/jest from 29.5.8 to 29.5.11 ([fd40f25](https://github.com/pryzmian/cadence-discord-bot/commit/fd40f251327ac769ca7d18353acb882465672f4f))
* **deps-dev:** bump @types/node from 20.10.4 to 20.10.5 ([a834e4b](https://github.com/pryzmian/cadence-discord-bot/commit/a834e4bfa80d96dd7a9f75f14f6619c760f92576))
* **deps-dev:** bump @types/node from 20.10.5 to 20.10.6 ([10513ba](https://github.com/pryzmian/cadence-discord-bot/commit/10513baf19a40dfdfdeb4e1d0eae433463a7fceb))
* **deps-dev:** bump @types/node from 20.10.6 to 20.10.7 ([8f37bfe](https://github.com/pryzmian/cadence-discord-bot/commit/8f37bfe557b5a561462eee1aca5135483bd5906f))
* **deps-dev:** bump @types/node from 20.10.7 to 20.11.2 ([c794128](https://github.com/pryzmian/cadence-discord-bot/commit/c7941285c564e3ce64c71b55aa113fb341c962ee))
* **deps-dev:** bump @types/node from 20.11.16 to 20.11.17 ([c7d6a30](https://github.com/pryzmian/cadence-discord-bot/commit/c7d6a3063b5d673e524409d85f08165592b31b8c))
* **deps-dev:** bump @types/node from 20.11.2 to 20.11.10 ([cd90e7f](https://github.com/pryzmian/cadence-discord-bot/commit/cd90e7fc126b5b5afbf790e934af38427f2943fd))
* **deps-dev:** bump @types/node from 20.11.20 to 20.11.24 ([44bc390](https://github.com/pryzmian/cadence-discord-bot/commit/44bc390305035ce2568f33bbca4f8e8c0ebf3412))
* **deps-dev:** bump @types/node from 20.11.24 to 20.11.25 ([931ab45](https://github.com/pryzmian/cadence-discord-bot/commit/931ab456eff6be63150509eedf31d83872bf3dd5))
* **deps-dev:** bump @types/node from 20.5.9 to 20.6.0 ([759171f](https://github.com/pryzmian/cadence-discord-bot/commit/759171fd6b492198e92900bb92f429617fb51220))
* **deps-dev:** bump @types/node from 20.6.0 to 20.6.2 ([97869a0](https://github.com/pryzmian/cadence-discord-bot/commit/97869a04fdb21a2afd98dac656ca677d06d26368))
* **deps-dev:** bump @types/node from 20.6.2 to 20.6.5 ([9684c8b](https://github.com/pryzmian/cadence-discord-bot/commit/9684c8b1f4de1e92f3b7bd29ef286d5b6763c65c))
* **deps-dev:** bump @types/node from 20.6.5 to 20.8.0 ([ef9381d](https://github.com/pryzmian/cadence-discord-bot/commit/ef9381d7d27572e44095119daecf57b961fca31d))
* **deps-dev:** bump @types/node from 20.8.0 to 20.8.4 ([963af52](https://github.com/pryzmian/cadence-discord-bot/commit/963af52470b4e25a920d6d5ece6c7dde10ba65c8))
* **deps-dev:** bump @types/node from 20.8.4 to 20.8.7 ([7dd5739](https://github.com/pryzmian/cadence-discord-bot/commit/7dd57395abf1ed9a4c8cad104143e9cb9f8920ad))
* **deps-dev:** bump @types/node from 20.8.8 to 20.8.10 ([8d35f0b](https://github.com/pryzmian/cadence-discord-bot/commit/8d35f0b4f9ecc5d53dc7620b3580cf1c8e3074ce))
* **deps-dev:** bump @types/node-os-utils from 1.3.1 to 1.3.2 ([5f2e0d5](https://github.com/pryzmian/cadence-discord-bot/commit/5f2e0d5f1cb05d85a784c1156a25dd988cc5d5e9))
* **deps-dev:** bump @types/node-os-utils from 1.3.2 to 1.3.3 ([3544c76](https://github.com/pryzmian/cadence-discord-bot/commit/3544c76c24e0886a249efcfb7f36da086a4cae9e))
* **deps-dev:** bump @types/node-os-utils from 1.3.3 to 1.3.4 ([9bdd4a7](https://github.com/pryzmian/cadence-discord-bot/commit/9bdd4a7aea645aa99022647324869f23094a9c27))
* **deps-dev:** bump @typescript-eslint/eslint-plugin ([3d7311e](https://github.com/pryzmian/cadence-discord-bot/commit/3d7311edc2dc24107211a1ddd0710de6121415f1))
* **deps-dev:** bump @typescript-eslint/eslint-plugin ([21aa0ca](https://github.com/pryzmian/cadence-discord-bot/commit/21aa0cae9e40075f97bb34b3d936a736095a7026))
* **deps-dev:** bump @typescript-eslint/eslint-plugin ([e59cd1f](https://github.com/pryzmian/cadence-discord-bot/commit/e59cd1fd67e74eea39b91076fc55e13ec7769c69))
* **deps-dev:** bump @typescript-eslint/eslint-plugin ([90b13db](https://github.com/pryzmian/cadence-discord-bot/commit/90b13dbdcf1b45d938b090ef9d9fd2491af8d4d8))
* **deps-dev:** bump @typescript-eslint/eslint-plugin ([c209881](https://github.com/pryzmian/cadence-discord-bot/commit/c2098816de6d743a4bc49fa8bf1521e8f5b7326a))
* **deps-dev:** bump @typescript-eslint/eslint-plugin ([2a8a3e5](https://github.com/pryzmian/cadence-discord-bot/commit/2a8a3e51b65ea4d50fca71b23f6dc0c6a88435c1))
* **deps-dev:** bump @typescript-eslint/eslint-plugin ([965fd60](https://github.com/pryzmian/cadence-discord-bot/commit/965fd60d54a16f6d55ef2e3a4230d901f98e8970))
* **deps-dev:** bump @typescript-eslint/eslint-plugin ([9d6931e](https://github.com/pryzmian/cadence-discord-bot/commit/9d6931ebe913082186f11b136c1ce46c0ba3687b))
* **deps-dev:** bump @typescript-eslint/eslint-plugin ([eed285c](https://github.com/pryzmian/cadence-discord-bot/commit/eed285c98990bfa702d7ed09a332884bdb3e312b))
* **deps-dev:** bump @typescript-eslint/eslint-plugin ([dfa4393](https://github.com/pryzmian/cadence-discord-bot/commit/dfa439368364b6a11169ac87fb54d2b681c68d61))
* **deps-dev:** bump @typescript-eslint/parser from 6.12.0 to 6.13.2 ([027cbb7](https://github.com/pryzmian/cadence-discord-bot/commit/027cbb7d170478acba17ead4804991c242107576))
* **deps-dev:** bump @typescript-eslint/parser from 6.15.0 to 6.16.0 ([ba94891](https://github.com/pryzmian/cadence-discord-bot/commit/ba9489175a42321a223353c791894a3e9d0ec2ad))
* **deps-dev:** bump @typescript-eslint/parser from 6.16.0 to 6.18.1 ([3fd12e3](https://github.com/pryzmian/cadence-discord-bot/commit/3fd12e3ff6b95a734e800ba5fa7f0c477f29cf6a))
* **deps-dev:** bump @typescript-eslint/parser from 6.18.1 to 6.19.0 ([737e82c](https://github.com/pryzmian/cadence-discord-bot/commit/737e82cc705e46f164922c63938aa98d49553b52))
* **deps-dev:** bump @typescript-eslint/parser from 6.19.0 to 6.19.1 ([af559c8](https://github.com/pryzmian/cadence-discord-bot/commit/af559c8654569a781e31c24d2463242a0c428d05))
* **deps-dev:** bump @typescript-eslint/parser from 6.19.1 to 6.20.0 ([54ca9ec](https://github.com/pryzmian/cadence-discord-bot/commit/54ca9ecfb9e4785fe0d463ee80be3f30a9c7856b))
* **deps-dev:** bump @typescript-eslint/parser from 6.6.0 to 6.7.0 ([2e9dd22](https://github.com/pryzmian/cadence-discord-bot/commit/2e9dd229da4d696f630d0f20ba628e41aec55ac3))
* **deps-dev:** bump @typescript-eslint/parser from 6.7.0 to 6.7.3 ([2bc1729](https://github.com/pryzmian/cadence-discord-bot/commit/2bc17298fa7b2678ab44f2d50d45260dd192263f))
* **deps-dev:** bump @typescript-eslint/parser from 6.7.3 to 6.7.5 ([229e32b](https://github.com/pryzmian/cadence-discord-bot/commit/229e32b955cfb1d110950eab2b8b0ba5be598520))
* **deps-dev:** bump @typescript-eslint/parser from 6.7.5 to 6.9.0 ([3789bf0](https://github.com/pryzmian/cadence-discord-bot/commit/3789bf0cb9a8b89c05c358c86ee6288d9ab9a0ba))
* **deps-dev:** bump @typescript-eslint/parser from 6.9.0 to 6.9.1 ([7c7fa4e](https://github.com/pryzmian/cadence-discord-bot/commit/7c7fa4e55d1861f1c2c3456accc93b6c6f12fb10))
* **deps-dev:** bump @typescript-eslint/parser from 6.9.1 to 6.12.0 ([600c1e9](https://github.com/pryzmian/cadence-discord-bot/commit/600c1e93fd43ebc4c1d53718731b9af7c066294c))
* **deps-dev:** bump @typescript-eslint/parser from 7.0.2 to 7.1.0 ([62a6ffb](https://github.com/pryzmian/cadence-discord-bot/commit/62a6ffb2683d597847698a0e9a856fc9d0b9c81d))
* **deps-dev:** bump @typescript-eslint/parser from 7.1.0 to 7.1.1 ([b337658](https://github.com/pryzmian/cadence-discord-bot/commit/b337658dde5c30e7f1c7b7252d04bcb0a53f33c5))
* **deps-dev:** bump eslint from 8.48.0 to 8.49.0 ([0f72034](https://github.com/pryzmian/cadence-discord-bot/commit/0f7203447739ee94be641cd5511976cc01d9141f))
* **deps-dev:** bump eslint from 8.49.0 to 8.50.0 ([ebae3f1](https://github.com/pryzmian/cadence-discord-bot/commit/ebae3f186cf77905267858c6e4f5e9e6c861f830))
* **deps-dev:** bump eslint from 8.50.0 to 8.51.0 ([ff2d82c](https://github.com/pryzmian/cadence-discord-bot/commit/ff2d82cd5b6aa88563e75ab2fecd1016d68036b9))
* **deps-dev:** bump eslint from 8.51.0 to 8.52.0 ([2e9ca21](https://github.com/pryzmian/cadence-discord-bot/commit/2e9ca212b27c54d5ed540936a8925d0443bef2ac))
* **deps-dev:** bump eslint from 8.52.0 to 8.53.0 ([b070635](https://github.com/pryzmian/cadence-discord-bot/commit/b070635353824c8c11d28de53fc409223ec5d89c))
* **deps-dev:** bump eslint from 8.55.0 to 8.56.0 ([6c4f3a9](https://github.com/pryzmian/cadence-discord-bot/commit/6c4f3a9d280631113f0b0f6a82428a069ae1fd94))
* **deps-dev:** bump eslint-plugin-prettier from 5.0.0 to 5.0.1 ([96cad41](https://github.com/pryzmian/cadence-discord-bot/commit/96cad413ed3aadd01a431e783f6529f987a68df5))
* **deps-dev:** bump eslint-plugin-prettier from 5.1.1 to 5.1.2 ([72b6490](https://github.com/pryzmian/cadence-discord-bot/commit/72b64909aec72329ec294dfd937c7e1e821ac9a4))
* **deps-dev:** bump eslint-plugin-prettier from 5.1.2 to 5.1.3 ([01568d3](https://github.com/pryzmian/cadence-discord-bot/commit/01568d3ef746b6a1fd1e3b283759193484a5a2f4))
* **deps-dev:** bump i18next-resources-for-ts from 1.4.0 to 1.5.0 ([fc16137](https://github.com/pryzmian/cadence-discord-bot/commit/fc16137427cbf5eec46646eae6b6e2a7f15c432f))
* **deps-dev:** bump prettier from 3.0.3 to 3.1.0 ([b638255](https://github.com/pryzmian/cadence-discord-bot/commit/b638255244dd1a9123b596824dc2c69ec2fcea59))
* **deps-dev:** bump prettier from 3.1.1 to 3.2.2 ([18b010a](https://github.com/pryzmian/cadence-discord-bot/commit/18b010ac80a12cddf134f539fd3aea9a16a5c259))
* **deps-dev:** bump ts-jest from 29.1.1 to 29.1.2 ([ef09de8](https://github.com/pryzmian/cadence-discord-bot/commit/ef09de8284bb670d92a973c3999a84fc9a289179))
* **deps-dev:** bump typescript from 5.2.2 to 5.3.2 ([bae6e9e](https://github.com/pryzmian/cadence-discord-bot/commit/bae6e9ecd14be426cdebbb1fb860f5d97cf5f6f2))
* **deps-dev:** bump typescript from 5.3.3 to 5.4.2 ([3495805](https://github.com/pryzmian/cadence-discord-bot/commit/3495805073c97f074de494ffa068bc6ada1b20b0))
* **deps:** bump @prisma/client from 5.7.1 to 5.8.1 ([82f352d](https://github.com/pryzmian/cadence-discord-bot/commit/82f352d613ce34835e77edbd891d6092472d6847))
* **deps:** bump config from 3.3.9 to 3.3.10 ([5c2cbab](https://github.com/pryzmian/cadence-discord-bot/commit/5c2cbab0c495934f810c451c4ba6409624922872))
* **deps:** bump discord-player from 6.6.5-dev.4 to 6.6.6 ([34ad44e](https://github.com/pryzmian/cadence-discord-bot/commit/34ad44ea5ffd35296c0f431904cbaf75fa96a423))
* **deps:** bump discord-player from 6.6.6 to 6.6.7 ([d89e1e6](https://github.com/pryzmian/cadence-discord-bot/commit/d89e1e60091b0730c2db72e5543196012a0f96fe))
* **deps:** bump dotenv from 16.3.1 to 16.4.1 ([f55b18b](https://github.com/pryzmian/cadence-discord-bot/commit/f55b18b0836b1a960470998fdb948bdf8e3a5605))
* **deps:** bump dotenv from 16.4.1 to 16.4.3 ([fee5cd1](https://github.com/pryzmian/cadence-discord-bot/commit/fee5cd166f74bafc179cd9a2fdbd0ed5e7caa1f3))
* **deps:** bump i18next from 23.10.0 to 23.10.1 ([edfce65](https://github.com/pryzmian/cadence-discord-bot/commit/edfce659b3c38875026270c23bd09756c7ed89de))
* **deps:** bump i18next from 23.7.11 to 23.7.13 ([425aac5](https://github.com/pryzmian/cadence-discord-bot/commit/425aac5ce6f3f89c9332370f43ede957d61c1398))
* **deps:** bump i18next from 23.7.13 to 23.7.16 ([748742a](https://github.com/pryzmian/cadence-discord-bot/commit/748742a2fceb22950f4fb41f5137eb8d060653e3))
* **deps:** bump i18next from 23.7.16 to 23.8.1 ([75b7ebb](https://github.com/pryzmian/cadence-discord-bot/commit/75b7ebb26adf6d9cd7503292e4b430142b4e6d94))
* **deps:** bump ip from 1.1.8 to 1.1.9 ([d0be0ce](https://github.com/pryzmian/cadence-discord-bot/commit/d0be0cea84e93d1a8b0c793b3034aab0f022c23c))
* **deps:** bump mediaplex from 0.0.6 to 0.0.7 ([a79cb44](https://github.com/pryzmian/cadence-discord-bot/commit/a79cb4467d3c02ad50229ba495b8cb83cbeabe0d))
* **deps:** bump mediaplex from 0.0.7 to 0.0.8 ([e348fc3](https://github.com/pryzmian/cadence-discord-bot/commit/e348fc368669a30bb66ef666d72318f83b72e374))
* **deps:** bump pino from 8.15.0 to 8.15.1 ([8814a55](https://github.com/pryzmian/cadence-discord-bot/commit/8814a55f92e256418d25cbbab671bfe000bc2026))
* **deps:** bump pino from 8.15.1 to 8.15.3 ([adb2174](https://github.com/pryzmian/cadence-discord-bot/commit/adb2174ffbaaa76182b60ca8c8ade820cdddc31d))
* **deps:** bump pino from 8.15.3 to 8.15.7 ([bc0c8bb](https://github.com/pryzmian/cadence-discord-bot/commit/bc0c8bbbc9c8371557428c64ffc4af0e2800d5ff))
* **deps:** bump pino from 8.16.1 to 8.16.2 ([9d92ad3](https://github.com/pryzmian/cadence-discord-bot/commit/9d92ad39fdfb1ea31066bb57e7b1b697dfbfef95))
* **deps:** bump pino from 8.16.2 to 8.17.1 ([d7a98c1](https://github.com/pryzmian/cadence-discord-bot/commit/d7a98c1f8605e5364019e18f94da853e67d3f31e))
* **deps:** bump pino from 8.17.1 to 8.17.2 ([80f8ec2](https://github.com/pryzmian/cadence-discord-bot/commit/80f8ec2fc4ff7f257d395fedb51f9c6850b932b9))
* **deps:** bump pino-loki from 2.1.3 to 2.2.1 ([1bd8e12](https://github.com/pryzmian/cadence-discord-bot/commit/1bd8e125303b4bfa4c2b202a6f420b67dbd95355))
* **deps:** bump pino-pretty from 10.3.0 to 10.3.1 ([637210b](https://github.com/pryzmian/cadence-discord-bot/commit/637210b4e0898ff4af9b1161fd6f6a7f3de26923))
* **deps:** bump youtube-ext from 1.1.14 to 1.1.16 ([0ae1993](https://github.com/pryzmian/cadence-discord-bot/commit/0ae19931ddc814426942cd879d379099207353f9))
* **deps:** Updated dependencies ([1728503](https://github.com/pryzmian/cadence-discord-bot/commit/1728503bb6c35ac0363214d3167216bfccc586d4))
* formatting strings to multiple lines ([e57dcaf](https://github.com/pryzmian/cadence-discord-bot/commit/e57dcaf399affd40d3ef28717a3b52b8ea6bc9df))
* **main:** release 5.3.0 ([aaf2b09](https://github.com/pryzmian/cadence-discord-bot/commit/aaf2b09f124785ec5c1379259a2de4165706dcea))
* **main:** release 5.3.1 ([66022d7](https://github.com/pryzmian/cadence-discord-bot/commit/66022d78ab370819ba580f4e826e05757295fa1e))
* **main:** release 5.3.2 ([f3dbaea](https://github.com/pryzmian/cadence-discord-bot/commit/f3dbaea49e6d793c0d9c4f226ccef190ac63d4f2))
* **main:** release 5.3.3 ([8977bf4](https://github.com/pryzmian/cadence-discord-bot/commit/8977bf434c462dc274b19fe4fd8bce6c3b2c369d))
* **main:** release 5.3.4 ([d04a093](https://github.com/pryzmian/cadence-discord-bot/commit/d04a093bbbf49d45817e66870d1e2aa0978652ee))
* **main:** release 5.3.5 ([a13c9f9](https://github.com/pryzmian/cadence-discord-bot/commit/a13c9f998462e24366771b1e932ec814fa0dafcf))
* **main:** release 5.3.6 ([7447688](https://github.com/pryzmian/cadence-discord-bot/commit/744768808c08db646fd672dd1158849b030256dd))
* **main:** release 5.3.7 ([46193a9](https://github.com/pryzmian/cadence-discord-bot/commit/46193a94f17766cd48cc3355fe140c507d6d377e))
* **main:** release 5.3.8 ([f09a166](https://github.com/pryzmian/cadence-discord-bot/commit/f09a166e81f955065a820715c3f7ed885eaba922))
* **main:** release 5.4.0 ([efa0d81](https://github.com/pryzmian/cadence-discord-bot/commit/efa0d81e596d3f3a860e981b642aa3e068e05545))
* **main:** release 5.4.1 ([6b4faf7](https://github.com/pryzmian/cadence-discord-bot/commit/6b4faf7e7437e0a0a35320a06c11cc4d8298fd36))
* **main:** release 5.5.0 ([68f8cff](https://github.com/pryzmian/cadence-discord-bot/commit/68f8cff119231e85d64aa1d5a2a9e1f7ece0a958))
* **main:** release 5.6.0 ([309349e](https://github.com/pryzmian/cadence-discord-bot/commit/309349ebb1108195fec620ea9f6d452953815dba))
* **main:** release 5.6.1 ([cc28c04](https://github.com/pryzmian/cadence-discord-bot/commit/cc28c04426adaaff89657ac16c89fafb392f8b6c))
* **main:** release 5.6.2 ([758a171](https://github.com/pryzmian/cadence-discord-bot/commit/758a17157ef19153a4e77a4c426d83d46677ef23))
* **main:** release 5.6.3 ([00a6ecc](https://github.com/pryzmian/cadence-discord-bot/commit/00a6eccb19457ca0c9e7d955fcb01079f3624abd))
* **main:** release 5.6.4 ([005893e](https://github.com/pryzmian/cadence-discord-bot/commit/005893e04c433f710c898390f83b0f3666f0b57d))
* **main:** release 5.6.5 ([66f6647](https://github.com/pryzmian/cadence-discord-bot/commit/66f6647dc625e37c336c35a194d24ae36c24d83a))
* **main:** release 5.6.6 ([ab93c25](https://github.com/pryzmian/cadence-discord-bot/commit/ab93c25f1644edca05b585fe4e35684364f10475))
* **main:** release 5.6.7 ([adc6d69](https://github.com/pryzmian/cadence-discord-bot/commit/adc6d69dabd4cbc272b5710ff6d7f57cbb799273))
* **main:** release 5.6.8 ([5059c5d](https://github.com/pryzmian/cadence-discord-bot/commit/5059c5dd615f784ded72307f2ad189950f17daa1))
* **main:** release 5.7.0 ([7c7c233](https://github.com/pryzmian/cadence-discord-bot/commit/7c7c2330c415c75bc39965a5f7501685e9fc94fb))
* more type annotations ([10c03d5](https://github.com/pryzmian/cadence-discord-bot/commit/10c03d599f9eb060304b10e5e5b6572c7ab253b0))
* update volume command options ([46a81fb](https://github.com/pryzmian/cadence-discord-bot/commit/46a81fb474b223c16584c88b9339c125c74003d1))
* update volume command options and remove duplicate file ([d48503f](https://github.com/pryzmian/cadence-discord-bot/commit/d48503f565f4b0104e9f48891ece6c808e1f81f9))
